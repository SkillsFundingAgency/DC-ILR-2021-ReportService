...
namespace ESFA.DC.ILR.ReportService.Reports.Tests.Funding.NonContractedAppsActivity
{
    public class NonContractedAppsActivityReportTests
    {
        ...
        public async Task GenerateAsync()
        {
            ...
            csvServiceMock.Verify(s => s.WriteAsync<NonContractedAppsActivityReportModel, NonContractedAppsActivityReportClassMap>(model, fileName, container, cancellationToken, null, null));
