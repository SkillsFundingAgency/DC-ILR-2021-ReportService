...
namespace ESFA.DC.ILR.ReportService.Reports.Tests.Funding.FundingSummary.AEBSTF
{
    public class AEBSTFFundingSummaryReportTests
    {
        ...
        public async Task GenerateAsync()
        {
            ...
            var fundingSummaryReportModelBuilderMock = new Mock<IModelBuilder<AEBSTFFundingSummaryReportModel>>();
            ...
            var fundingSummaryReportModel = Mock.Of<IFundingSummaryReport>().As<AEBSTFFundingSummaryReportModel>();
            ...
            fileNameServiceMock.Setup(s => s.GetFilename(reportServiceContextMock.Object, "AEB Short Term Funding Initiatives Funding Summary Report", OutputTypes.Excel, true)).Returns(fileName);
        ...
        public async Task SystemTest()
        {
            ...
            var fundingSummaryReportModelBuilder = new AEBSTFFundingSummaryReportModelBuilder(periodisedValuesLookupProvider.Object, dateTimeProviderMock.Object);
        ...
        private AEBSTFFundingSummaryReport NewReport(
            IFileNameService fileNameService = null,
            IModelBuilder<AEBSTFFundingSummaryReportModel> fundingSummaryReportModelBuilder = null,
            IExcelFileService excelService = null,
            IRenderService<IFundingSummaryReport> fundingSummaryReportRenderService = null)
        {
            return new AEBSTFFundingSummaryReport(fileNameService, fundingSummaryReportModelBuilder, excelService, fundingSummaryReportRenderService);
        }
    }
}
