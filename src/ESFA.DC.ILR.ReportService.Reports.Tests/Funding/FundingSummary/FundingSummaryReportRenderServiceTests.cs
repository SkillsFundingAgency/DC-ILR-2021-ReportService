    ...
    public class FundingSummaryReportRenderServiceTests
    {
        ...
        public void Render()
        {
            ...
            var fundingSummaryReport = new FundingSummaryReport(Enumerable.Range(1, 5)
                .Select(l => (IFundingCategory)new FundingCategory("Title", "FCTitle", "CFCTitle", Enumerable.Range(1, 20)
                    .Select(k => (IFundingSubCategory)new FundingSubCategory("Funding Sub Category SubTitle", "Funding SubCategory Title", Enumerable.Range(1, 5)
                        .Select(i => (IFundLineGroup)new FundLineGroup("FundLineGroup", Enumerable.Range(0, 200)
