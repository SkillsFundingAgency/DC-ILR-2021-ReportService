...
{
    public class NonContractDevolvedAdultEducationOccupancyReportClassMap : ClassMap<NonContractDevolvedAdultEducationOccupancyReportModel>
    {
        public NonContractDevolvedAdultEducationOccupancyReportClassMap()
        {
            int index = 0;
