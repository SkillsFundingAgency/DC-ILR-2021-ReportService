    ...
    public class FundingClaimReportModelBuilder : AbstractSixteenToNineteenReportModelBuilder , IModelBuilder<FundingClaimReportModel>
    {
        ...
        private FundingLineReportingBandModel BuildFundlineReprtingBandModelForProgrammes(List<FM25Learner> fm25ProgrammeLearners, List<FM25Learner> fm25TLevelLearners)
        {
            var model = new FundingLineReportingBandModel()
            {
                ...
                Band5StudentNumbersTLevel = fm25TLevelLearners.Count(Band5),
                Band5TotalFundingTLevel = SumOnProgPaymentsForRateBand(fm25TLevelLearners, Band5),
                Band4aStudentNumbersTLevel = fm25TLevelLearners.Count(Band4a),
                Band4aTotalFundingTLevel = SumOnProgPaymentsForRateBand(fm25TLevelLearners, Band4a),
                Band4bStudentNumbersTLevel = fm25TLevelLearners.Count(Band4b),
                Band4bTotalFundingTLevel = SumOnProgPaymentsForRateBand(fm25TLevelLearners, Band4b),
                Band3StudentNumbersTLevel = fm25TLevelLearners.Count(Band3),
                Band3TotalFundingTLevel = SumOnProgPaymentsForRateBand(fm25TLevelLearners, Band3),
                Band2StudentNumbersTLevel = fm25TLevelLearners.Count(Band2),
                Band2TotalFundingTLevel = SumOnProgPaymentsForRateBand(fm25TLevelLearners, Band2),
                Band1StudentNumbersTLevel = fm25TLevelLearners.Count(Band1),
                Band1TotalFundingTLevel = SumOnProgPaymentsForRateBand(fm25TLevelLearners, Band1),
