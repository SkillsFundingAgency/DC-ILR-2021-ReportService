...
{
    public class MathsAndEnglishReportModelBuilder : IModelBuilder<IEnumerable<MathsAndEnglishReportModel>>
    {
        private IDictionary<string, int?> _fundModelDictionary =
        ...
        private IDictionary<string, FM25Learner> BuildFm25LearnerDictionary(FM25Global fm25Global) 
            => fm25Global?
                  .Learners?
