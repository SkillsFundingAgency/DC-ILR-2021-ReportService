...
namespace ESFA.DC.ILR.ReportService.Data.Providers
{
    public class Fm36Provider : AbstractFileServiceProvider, IExternalDataProvider
    {
        ...
        {
            var fm36Global = await ProvideAsync<FundingService.FM36.FundingOutput.Model.Output.FM36Global>(reportServiceContext.FundingFM36OutputKey, reportServiceContext.Container, cancellationToken) as FundingService.FM36.FundingOutput.Model.Output.FM36Global;

            return MapData(fm36Global);
        }

        private FM36Global MapData(FundingService.FM36.FundingOutput.Model.Output.FM36Global fm36Global)
        {
