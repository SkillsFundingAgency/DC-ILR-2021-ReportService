...
//            loggerMock.Verify(l => l.LogWarning($"Missing Report Task - {reportFourTaskName}", null, 0, It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>()));
//            loggerMock.Verify(l => l.LogWarning($"Missing Report Task - {reportFiveTaskName}", null, 0, It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>()));
//            loggerMock.Verify(l => l.LogWarning($"Missing Report Task - {reportSixTaskName}", null, 0, It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>()));
//        }
