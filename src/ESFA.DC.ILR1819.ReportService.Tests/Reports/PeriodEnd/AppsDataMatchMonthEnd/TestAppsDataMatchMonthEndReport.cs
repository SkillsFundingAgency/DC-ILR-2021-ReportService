...
namespace ESFA.DC.ILR1819.ReportService.Tests.Reports.PeriodEnd.AppsDataMatchMonthEnd
{
    public sealed class TestAppsDataMatchMonthEndReport
    {
        ...
        public async Task TestAppsDataMatchMonthEndReportGeneration()
        {
            ...
            IFM36ProviderService fm36ProviderService = new FM36ProviderService(logger.Object, storage.Object, storage.Object, jsonSerializationService, intUtilitiesService, IlrRulebaseValidContextFactory);
