...
{
    public class Fm35ProviderTests
    {
        private readonly ITestOutputHelper _testOutputHelper;

        public Fm35ProviderTests(ITestOutputHelper testOutputHelper)
        {
        ...
        private Fm35Provider NewService(Func<IILR1920_DataStoreEntities> context)
        {
            return new Fm35Provider(context);
        }
