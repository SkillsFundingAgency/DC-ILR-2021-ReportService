...
{
    public class Fm36ProviderTests
    {
        private readonly ITestOutputHelper _testOutputHelper;

        public Fm36ProviderTests(ITestOutputHelper testOutputHelper)
        {
        ...
        private Fm36Provider NewService(Func<IILR1920_DataStoreEntities> context)
        {
            return new Fm36Provider(context);
        }
