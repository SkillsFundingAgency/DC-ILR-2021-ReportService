...
{
    public sealed class MainOccupancyFM35ModelComparer : IComparer<MainOccupancyFM35Model>
    {
        public int Compare(MainOccupancyFM35Model x, MainOccupancyFM35Model y)
        {
            if (x == null && y == null)
            {
                return 0;
