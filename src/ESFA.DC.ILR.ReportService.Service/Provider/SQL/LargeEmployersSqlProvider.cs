...
{
    public sealed class LargeEmployersSqlProvider : ILargeEmployerProviderService
    {
        ...
        public LargeEmployersSqlProvider(ILogger logger, IReportServiceConfiguration reportServiceConfiguration)
        {
            _logger = logger;
