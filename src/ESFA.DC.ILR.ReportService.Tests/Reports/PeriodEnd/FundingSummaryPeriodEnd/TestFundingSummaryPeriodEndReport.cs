...
namespace ESFA.DC.ILR.ReportService.Tests.Reports.PeriodEnd.FundingSummaryPeriodEnd
{
    public sealed class TestFundingSummaryPeriodEndReport
    {
        ...
        public async Task TestFundingSummaryPeriodEndReportGeneration()
        {
            ...
            var report = new ILR1819.ReportService.Service.Reports.PeriodEnd.FundingSummaryPeriodEndReport(logger.Object, storage.Object, ilrProviderService, fm36ProviderService, stringUtilitiesService, dateTimeProviderMock.Object, valueProvider, topicsAndTasks, fundingSummaryPeriodEndModelBuilder);
