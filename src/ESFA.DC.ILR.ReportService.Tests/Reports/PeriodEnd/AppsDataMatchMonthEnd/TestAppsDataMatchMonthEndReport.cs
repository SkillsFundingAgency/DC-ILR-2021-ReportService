...
namespace ESFA.DC.ILR.ReportService.Tests.Reports.PeriodEnd.AppsDataMatchMonthEnd
{
    public sealed class TestAppsDataMatchMonthEndReport
    {
        ...
        public async Task TestAppsDataMatchMonthEndReportGeneration()
        {
            ...
            var report = new ILR1819.ReportService.Service.Reports.PeriodEnd.AppsDataMatchMonthEndReport(logger.Object, storage.Object, ilrProviderService, fm36ProviderService, stringUtilitiesService, dateTimeProviderMock.Object, valueProvider, topicsAndTasks, appsDataMatchMonthEndModelBuilder);
