...
namespace ESFA.DC.ILR.ReportService.Tests.Reports.PeriodEnd.AppsMonthlyPayment
{
    public sealed class TestAppsMonthlyPaymentReport
    {
        ...
        public async Task TestAppsMonthlyPaymentReportGeneration()
        {
            ...
            var report = new ILR1819.ReportService.Service.Reports.PeriodEnd.AppsMonthlyPaymentReport(logger.Object, storage.Object, ilrProviderService, fm36ProviderService, stringUtilitiesService, dateTimeProviderMock.Object, valueProvider, topicsAndTasks, appsMonthlyPaymentModelBuilder);
